<?php 
/*
Plugin Name: jQuery Smooth Scroll EstiIoT Customized
Version: 1.4.1
Plugin URI: http://www.blogsynthesis.com/wordpress-jquery-smooth-scroll-plugin/
Description: EstiIoT Version. The plugin not only add smooth scroll to top feature/link in the lower-right corner of long pages while scrolling but also makes all jump links to scroll smoothly.
...
if ( !class_exists( 'jQuerySmoothScroll' ) ) {
	...
	class jQuerySmoothScroll {
		...
		public function __construct() {
			...
			// add move to top button at wp_footer --DISABLED--
